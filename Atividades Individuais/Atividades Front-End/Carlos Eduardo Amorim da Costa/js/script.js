...
let someBotao = document.querySelector("a.botao#add");
botaoAdicionar.addEventListener('click', () => {
    form.classList.remove('inativo');
    someBotao.classList.replace('botao','inativo');
});
...
botaoCancelar.addEventListener('click', () => {
    ...
    form.reset();
    someBotao.classList.replace('inativo','botao');
})
...
let rodape = document.querySelector("td.rodape");
const qtdProfissionaisTabela = () =>{
    let profissionaisTabela = tabela.tBodies[0].rows.length;
    // console.log(profissionaisTabela)
    rodape.innerHTML = "Total de registros: "+ profissionaisTabela;
}