...
<body>
    ...
    <main>
        <form id="addForm" action="" class="inativo">
            <div class="grid">
                ...
                <!-- <br> -->
                <span></span>
                <input type="submit" value="Enviar" id="verde">
                <span></span>
        ...
        <form id="editForm" action="" class="inativo">
            <div class="grid">
                <label for="editNomeProfissional">Nome</label>
                <input type="text" name="nome" id="editNomeProfissional" required>
                <span></span>
                <input type="submit" value="Salvar">
                <span></span>
                <input type="button" value="Cancelar" id="cancelarEdicao">
            </div>
        </form>
    </main>
    <footer>
